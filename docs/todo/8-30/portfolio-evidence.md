...
| Remem contract | Host-bound raw-session contract is merged; installed-binary and live-session proof is still open. | implementation merged / acceptance open | [PR #1054](https://github.com/majiayu000/remem/pull/1054), [Issue #1053](https://github.com/majiayu000/remem/issues/1053) | Complete real installed-binary and live-session proof. |
| Refine cutover | Remem-only coding-session ingestion is merged; issue-close proof is still open. | implementation merged / acceptance open | [PR #206](https://github.com/majiayu000/refine/pull/206), [Issue #203](https://github.com/majiayu000/refine/issues/203), [Issue #204](https://github.com/majiayu000/refine/issues/204) | Complete real cutover and bounded unattended-ingestion proof. |

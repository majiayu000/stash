...
/**
 * v0.6 — task recurrence and reminder pickers save through to the API.
 *
 * 1. Create a work item via API.
 * 2. Open /todos/:id, change "repeats" to "daily".
 * 3. API reports recurrence.type === 'rrule' AND freq === 'DAILY'.
 */
test('Task detail recurrence picker writes recurrence to the API', async ({ page, request }) => {
